...
<p align="center">
  <a href="https://github.com/Mr-Destroyer/XSStrike/releases">
...
<p align="center">
  <a href="https://github.com/s0md3v/XSStrike/wiki">XSStriker Wiki</a> •
...
XSStriker is a Cross Site Scripting detection suite equipped with four hand written parsers, an intelligent payload generator, a powerful fuzzing engine and an incredibly fast crawler.
...
```
Apart from that, XSStriker has crawling, fuzzing, parameter discovery, WAF detection capabilities as well. It also scans for DOM XSS vulnerabilities.
